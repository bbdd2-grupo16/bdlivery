...
public class DBliveryServiceImpl implements DBliveryService{
     ...
     */
    public abstract Product createProduct(String name, Float price, Float weight, Supplier supplier);
     ...
     */
    public abstract Supplier createSupplier(String name, String cuil, String address, Float coordX, Float coordY);
     ...
     */
    public abstract User createUser(String email, String password, String username, String name, Date dateOfBirth);
     ...
     */
    public abstract Product updateProductPrice(Long id, Float price, Date startDate) throws DBliveryException;
     ...
     */
    public abstract Order createOrder(Date dateOfOrder, String address, Float coordX, Float coordY, User client);
     ...
     */
    public abstract Order addProduct(Long order, Long quantity, Product product)throws DBliveryException;
     ...
     */
    public abstract Order deliverOrder(Long order, User deliveryUser) throws DBliveryException;
     ...
     */
    public abstract Order cancelOrder(Long order) throws DBliveryException;
     ...
     */
    public abstract Order finishOrder(Long order) throws DBliveryException;
     ...
     */
    public abstract boolean canCancel(Long order) throws DBliveryException;
     ...
     * @throws DBliveryException en caso de no existir el pedido
     */
    public abstract boolean canFinish(Long id) throws DBliveryException;
     ...
     */
    public abstract boolean canDeliver(Long order) throws DBliveryException;
     ...
     */
    public abstract OrderStatus getActualStatus(Long order);
     ...
     */
    public abstract List<Product> getProductByName(String name);
}
